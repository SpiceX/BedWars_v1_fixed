...
use BedWars\{Entityfbw\typesfbw\HumanEntityfbw, Entityfbw\typesfbw\TopsEntityfbw, Entityfbw\typesfbw\TopsEntityfbwkill};
use BedWars\BedWars;
...
class EntityUpdatefbw extends Task
{
	...
	{
		$comment = Color::GREEN . '§l»' . Color::YELLOW . 'BEDWARS' . Color::GRAY . '§a«' . "\n";
		$title = Color::BOLD . '§bTap Top Play' . "\n";
		$subtitle = Color::GREEN . self::getTotalPlayersInGame() . ' playing' . "\n";
	...
	public static function Topkills(): string
	{
		...
		$tops = [];
		$title = "§l§aLEADERBOARD\n§r§eBedwars kills" . Color::RESET . "\n";
